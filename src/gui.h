...
GtkWidget *gui_button_add( GtkWidget *parent_w, const char *label, GCallback callback, void *callback_data );
GtkWidget *gui_button_with_pixmap_xpm_add( GtkWidget *parent_w, char **xpm_data, const char *label, GCallback callback, void *callback_data );
...
GtkWidget *gui_entry_add( GtkWidget *parent_w, const char *init_text, GCallback callback, void *callback_data );
